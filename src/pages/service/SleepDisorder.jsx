  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: "660px", width: "100%" }}>
        ...
        <p style={{ paddingBottom: "1rem", marginLeft: "10px" }}>
        ...
        <p style={{ paddingBottom: "1rem"}}><span>Restorative Sleep, Renewed Vitality:</span>Our goal is to empower you to achieve lasting improvements in your sleep quality for overall health and well-being.</p>

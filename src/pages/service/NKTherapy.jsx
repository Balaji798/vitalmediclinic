  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: "660px", width: "100%" }}>
        ...
        <p style={{ padding: "1rem 0" }}>
          Natural Killer (NK) cells are a powerful type of white blood cell that
          form a critical part of your {"body's"} innate immune system. They act
          as a first-line defense, rapidly identifying and eliminating
          potentially harmful cells, including cancer cells and virus-infected
          cells. NK Cell Therapy aims to boost the quantity and effectiveness of
          your NK cells to enhance your {"body's"} ability to fight disease.
        </p>
        ...
        <p>
          <span>• Targeted Attack:</span> These supercharged NK cells are better
          equipped to seek out and destroy cancerous or infected cells,
          bolstering your natural immune defenses.
        </p>
        <span>Potential Benefits of NK Cell Therapy:</span>
        <p>
          <span>• Cancer Treatment:</span> Can be used as a standalone treatment
          or alongside traditional cancer therapies for various malignancies,
